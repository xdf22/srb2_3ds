...
//  0--1
	...
	v[3].y = v[2].y = 1-(y*sdupy-gpatch->topoffset*pdupy)/vid.height;
	v[1].y = v[0].y = 1-(y*sdupy+(gpatch->height-gpatch->topoffset)*pdupy)/vid.height;

	v[3].z = v[2].z = v[1].z = v[0].z = 1.0f;

	v[0].sow = v[3].sow = 0.0f;
	v[2].sow = v[1].sow = gpatch->max_s;
	v[3].tow = v[2].tow = 0.0f;
	v[1].tow = v[0].tow = gpatch->max_t;
