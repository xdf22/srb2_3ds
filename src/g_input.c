...
/*
	...
	NOTE: This doesn't work, because SRB2 will parse "A BUTTON"
	as the KEY_ENTER key, instead of using it for jumping.
*/
	{KEY_ENTER, "ENTER"},
	{KEY_TAB, "TAB"},
	{KEY_ESCAPE, "ESCAPE"},
	...
	{KEY_MOUSE1+1,"MOUSE2"},
	{KEY_MOUSE1+2,"MOUSE3"},
#if !defined (_arch_dreamcast) && !defined (_XBOX) && !defined (_PSP) && !defined (_WII) && !defined (_NDS)
	{KEY_MOUSE1+3,"MOUSE4"},
	{KEY_MOUSE1+4,"MOUSE5"},
	{KEY_MOUSE1+5,"MOUSE6"},
	{KEY_MOUSE1+6,"MOUSE7"},
...
#define NOMOREJOYBTN_1S
	...
	{KEY_JOY1+2, "X BUTTON"},
	{KEY_JOY1+3, "Y BUTTON"},
	{KEY_JOY1+4, "L TRIGGER"},
	{KEY_JOY1+5, "R TRIGEER"},
	{KEY_JOY1+6, "START"},
	{KEY_JOY1+7, "SELECT"},
	{KEY_JOY1+8, "ZL"},
	{KEY_JOY1+9, "ZR"},
	{KEY_JOY1+10, "C-STICK RIGHT"},
	{KEY_JOY1+11, "C-STICK LEFT"},
	{KEY_JOY1+12, "C-STICK UP"},
	{KEY_JOY1+13, "C-STICK DOWN"},
#define NOMOREJOYBTN_1S
...
#define NOMOREJOYBTN_1S
	...
	{KEY_HAT1+2, "HATLEFT"},
	{KEY_HAT1+3, "HATRIGHT"},
#if !defined (_XBOX) && !defined (_PSP) && !defined (_WII) && !defined (_NDS)
	{KEY_HAT1+4, "HATUP2"},
	{KEY_HAT1+5, "HATDOWN2"},
	{KEY_HAT1+6, "HATLEFT2"},
...
void G_Controldefault(void)
{
	...
	gamecontrol[gc_use        ][0] = KEY_JOY1+2; //X
	gamecontrol[gc_strafeleft ][0] = KEY_JOY1+4; //L
	gamecontrol[gc_straferight][0] = KEY_JOY1+5; //R
